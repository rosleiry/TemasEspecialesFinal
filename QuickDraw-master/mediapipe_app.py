...
if torch.cuda.is_available():
    model = torch.load("C:\\Users\\Administrator\\Downloads\\QuickDraw-master\\QuickDraw-master\\trained_models\whole_model_quickdraw")
else:
    model = torch.load("C:\\Users\\Administrator\\Downloads\\QuickDraw-master\\QuickDraw-master\\trained_models\whole_model_quickdraw", map_location=lambda storage, loc: storage)
model.eval()
...
is_drawing = False
is_shown = False
class_images = get_images("C:\\Users\\Administrator\\Downloads\\QuickDraw-master\\QuickDraw-master\\images", CLASSES)
